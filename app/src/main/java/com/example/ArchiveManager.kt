...
object ArchiveManager {
    ...
    private fun extractZipArchive(
        ...
        ZipFile(archiveFile).use { zip ->
            ...
            for (entry in filteredEntries) {
                ...
                if (!canonicalOutputFile.path.startsWith(targetDir.path)) {
    ...
    private fun extractTarArchive(
        ...
        rawIn.use { stream ->
            ...
            for (entry in filtered) {
                ...
                if (!canonicalOut.path.startsWith(targetDir.path)) continue
    ...
    private fun extractGzArchive(
        ...
        if (!canonicalOut.path.startsWith(targetDir.path)) {
